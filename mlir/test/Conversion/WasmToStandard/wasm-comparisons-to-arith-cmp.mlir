...
module {
  wasm.func nested @func_lt_si32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.lt_si %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }

  wasm.func nested @func_le_si32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.le_si %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_lt_ui32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.lt_ui %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_le_ui32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.le_ui %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_gt_si32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.gt_si %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_gt_ui32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.gt_ui %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ge_si32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.ge_si %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ge_ui32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.ge_ui %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_lt_si64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.lt_si %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_le_si64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.le_si %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_lt_ui_i64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.lt_ui %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_le_ui_i64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.le_ui %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_gt_si_i64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.gt_si %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_gt_ui_i64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.gt_ui %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ge_si_i64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.ge_si %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ge_ui_i64() -> i32 {
    %0 = wasm.const 12 : i64
    %1 = wasm.const 50 : i64
    %2 = wasm.ge_ui %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_lt_f32() -> i32 {
    %0 = wasm.const 5.000000e+00 : f32
    %1 = wasm.const 1.400000e+01 : f32
    %2 = wasm.lt %0 %1 : f32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_le_f32() -> i32 {
    %0 = wasm.const 5.000000e+00 : f32
    %1 = wasm.const 1.400000e+01 : f32
    %2 = wasm.le %0 %1 : f32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_gt_f32() -> i32 {
    %0 = wasm.const 5.000000e+00 : f32
    %1 = wasm.const 1.400000e+01 : f32
    %2 = wasm.gt %0 %1 : f32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ge_f32() -> i32 {
    %0 = wasm.const 5.000000e+00 : f32
    %1 = wasm.const 1.400000e+01 : f32
    %2 = wasm.ge %0 %1 : f32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_lt_f64() -> i32 {
    %0 = wasm.const 5.000000e+00 : f64
    %1 = wasm.const 1.400000e+01 : f64
    %2 = wasm.lt %0 %1 : f64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_le_f64() -> i32 {
    %0 = wasm.const 5.000000e+00 : f64
    %1 = wasm.const 1.400000e+01 : f64
    %2 = wasm.le %0 %1 : f64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_gt_f64() -> i32 {
    %0 = wasm.const 5.000000e+00 : f64
    %1 = wasm.const 1.400000e+01 : f64
    %2 = wasm.gt %0 %1 : f64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ge_f64() -> i32 {
    %0 = wasm.const 5.000000e+00 : f64
    %1 = wasm.const 1.400000e+01 : f64
    %2 = wasm.ge %0 %1 : f64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_eq_i32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.eq %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_eq_i64() -> i32 {
    %0 = wasm.const 20 : i64
    %1 = wasm.const 5 : i64
    %2 = wasm.eq %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_eq_f32() -> i32 {
    %0 = wasm.const 5.000000e+00 : f32
    %1 = wasm.const 1.400000e+01 : f32
    %2 = wasm.eq %0 %1 : f32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_eq_f64() -> i32 {
    %0 = wasm.const 1.700000e+01 : f64
    %1 = wasm.const 0.000000e+00 : f64
    %2 = wasm.eq %0 %1 : f64 -> i32
    wasm.return %2 : i32
  }
    wasm.func nested @func_ne_i32() -> i32 {
    %0 = wasm.const 12 : i32
    %1 = wasm.const 50 : i32
    %2 = wasm.ne %0 %1 : i32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ne_i64() -> i32 {
    %0 = wasm.const 20 : i64
    %1 = wasm.const 5 : i64
    %2 = wasm.ne %0 %1 : i64 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ne_f32() -> i32 {
    %0 = wasm.const 5.000000e+00 : f32
    %1 = wasm.const 1.400000e+01 : f32
    %2 = wasm.ne %0 %1 : f32 -> i32
    wasm.return %2 : i32
  }
  wasm.func nested @func_ne_f64() -> i32 {
    %0 = wasm.const 1.700000e+01 : f64
    %1 = wasm.const 0.000000e+00 : f64
    %2 = wasm.ne %0 %1 : f64 -> i32
    wasm.return %2 : i32
  }
}
