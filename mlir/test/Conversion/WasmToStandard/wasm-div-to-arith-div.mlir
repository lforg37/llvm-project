...
"wasm.func"() <{functionType = (i32, i32) -> i32, sym_name = "div_i32_si", sym_visibility = "nested"}> ({
...
// CHECK-SAME:                      %[[VAL_0:.*]]: i32,
// CHECK-SAME:                      %[[VAL_1:.*]]: i32) -> i32 {
"wasm.func"() <{functionType = (i32, i32) -> i32, sym_name = "div_i32_ui", sym_visibility = "nested"}> ({
^bb0(%arg0: i32, %arg1: i32):
...
"wasm.func"() <{functionType = (i64, i64) -> i64, sym_name = "div_i64_si", sym_visibility = "nested"}> ({
...
// CHECK-SAME:                      %[[VAL_0:.*]]: i64,
// CHECK-SAME:                      %[[VAL_1:.*]]: i64) -> i64 {
"wasm.func"() <{functionType = (i64, i64) -> i64, sym_name = "div_i64_ui", sym_visibility = "nested"}> ({
^bb0(%arg0: i64, %arg1: i64):
...
"wasm.func"() <{functionType = (f32, f32) -> f32, sym_name = "div_f32", sym_visibility = "nested"}> ({
...
"wasm.func"() <{functionType = (f64, f64) -> f64, sym_name = "div_f64", sym_visibility = "nested"}> ({
