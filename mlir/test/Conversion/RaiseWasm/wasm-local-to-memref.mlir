...
// CHECK:           %[[VAL_7:.*]] = arith.cmpf oge, %[[VAL_5]], %[[VAL_6]] : f32
// CHECK:           %[[VAL_8:.*]] = arith.extui %[[VAL_7]] : i1 to i32
...
// CHECK:           %[[VAL_7:.*]] = arith.cmpi uge, %[[VAL_5]], %[[VAL_6]] : i32
// CHECK:           %[[VAL_8:.*]] = arith.extui %[[VAL_7]] : i1 to i32
// CHECK:           return %[[VAL_8]] : i32
// CHECK:         }
