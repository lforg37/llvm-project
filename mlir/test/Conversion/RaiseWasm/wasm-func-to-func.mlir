...
wasmssa.func nested @callee(%arg0: !wasmssa<local ref to i32>) -> i32 {
...
wasmssa.func nested @caller(%arg0: !wasmssa<local ref to i32>) -> i32 {
// CHECK:           %[[VAL_0:.*]] = memref.alloca() : memref<i32>
// CHECK:           memref.store %[[ARG0]], %[[VAL_0]][] : memref<i32>
// CHECK:           %[[VAL_1:.*]] = memref.load %[[VAL_0]][] : memref<i32>
%v0 = wasmssa.local_get %arg0 : ref to i32
...
wasmssa.func nested @user_of_func0() -> i32 {
