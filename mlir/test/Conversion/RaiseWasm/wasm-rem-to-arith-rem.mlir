...
wasmssa.func nested @rem_ui_32(%arg0: !wasmssa<local ref to i32>, %arg1: !wasmssa<local ref to i32>) -> i32 {
...
// CHECK:           return %[[VAL_4]] : i32
wasmssa.func nested @rem_si_32(%arg0: !wasmssa<local ref to i32>, %arg1: !wasmssa<local ref to i32>) -> i32 {
    %v0 = wasmssa.local_get %arg0: ref to i32
    %v1 = wasmssa.local_get %arg1: ref to i32
...
wasmssa.func nested @rem_ui_64(%arg0: !wasmssa<local ref to i64>, %arg1: !wasmssa<local ref to i64>) -> i64 {
...
// CHECK:           return %[[VAL_4]] : i64
wasmssa.func nested @rem_si_64(%arg0: !wasmssa<local ref to i64>, %arg1: !wasmssa<local ref to i64>) -> i64 {
    %v0 = wasmssa.local_get %arg0: ref to i64
    %v1 = wasmssa.local_get %arg1: ref to i64
