...
wasm.func nested @func_2() -> i32 {
  %0 = wasm.const 10 : i32
  %1 = wasm.extend 8 low bits from %0: i32
  wasm.return %1 : i32
}
...
wasm.func nested @func_3() -> i32 {
  %0 = wasm.const 10 : i32
  %1 = wasm.extend 16 low bits from %0: i32
  wasm.return %1 : i32
}
...
wasm.func nested @func_4() -> i64 {
  %0 = wasm.const 10 : i64
  %1 = wasm.extend 8 low bits from %0: i64
  wasm.return %1 : i64
}
...
wasm.func nested @func_5() -> i64 {
  %0 = wasm.const 10 : i64
  %1 = wasm.extend 16 low bits from %0: i64
  wasm.return %1 : i64
}
...
wasm.func nested @func_6() -> i64 {
  %0 = wasm.const 10 : i64
  %1 = wasm.extend 32 low bits from %0: i64
  wasm.return %1 : i64
}
