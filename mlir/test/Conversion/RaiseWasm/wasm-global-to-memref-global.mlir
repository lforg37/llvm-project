...
wasm.global @global_i32 i32 mutable : {
  %0 = wasm.const 66560 : i32
  wasm.return %0 : i32
}

wasm.global @global_i64 i64 mutable : {
  %0 = wasm.const 37017 : i64
  wasm.return %0 : i64
}

wasm.global @global_f32 f32 mutable : {
  %0 = wasm.const 0.125 : f32
  wasm.return %0 : f32
}

wasm.global @global_f64 f64 mutable : {
  %0 = wasm.const 3.14 : f64
  wasm.return %0 : f64
}

wasm.global @global_user0 i32 mutable : {
  %0 = wasm.global_get @global_top_define : i32
  wasm.return %0 : i32
}
...
// CHECK:         memref.global @global_f32 : memref<1xf32> = dense<1.250000e-01>
// CHECK:         memref.global @global_f64 : memref<1xf64> = dense<3.140000e+00>
// CHECK:         memref.global @global_user0 : memref<1xi32> = uninitialized
