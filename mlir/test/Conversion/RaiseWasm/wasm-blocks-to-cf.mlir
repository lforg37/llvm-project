...
// RUN: mlir-opt --split-input-file %s --raise-wasm-mlir --canonicalize -o - | FileCheck --check-prefix=CHECK-CANONICALIZED %s
...
// CHECK-CANONICALIZED-LABEL:   func.func @i_am_a_block(
// CHECK-CANONICALIZED-SAME:      %[[ARG0:.*]]: i32) -> i32 {
// CHECK-CANONICALIZED:           %[[VAL_0:.*]] = arith.constant 42 : i32
// CHECK-CANONICALIZED:           %[[VAL_1:.*]] = arith.constant 17 : i32
// CHECK-CANONICALIZED:           %[[VAL_2:.*]] = memref.alloca() : memref<i32>
// CHECK-CANONICALIZED:           memref.store %[[ARG0]], %[[VAL_2]][] : memref<i32>
// CHECK-CANONICALIZED:           memref.store %[[VAL_1]], %[[VAL_2]][] : memref<i32>
// CHECK-CANONICALIZED:           memref.store %[[VAL_0]], %[[VAL_2]][] : memref<i32>
// CHECK-CANONICALIZED:           %[[VAL_3:.*]] = memref.load %[[VAL_2]][] : memref<i32>
// CHECK-CANONICALIZED:           return %[[VAL_3]] : i32
...
// CHECK:           %[[VAL_3:.*]] = arith.cmpi uge, %[[VAL_1]], %[[VAL_2]] : i32
// CHECK:           %[[VAL_4:.*]] = arith.extui %[[VAL_3]] : i1 to i32
...
// CHECK-CANONICALIZED-LABEL:   func.func @branch_if_taken() -> i32 {
// CHECK-CANONICALIZED:           %[[VAL_0:.*]] = arith.constant 1 : i32
// CHECK-CANONICALIZED:           return %[[VAL_0]] : i32
...
// CHECK:           %[[VAL_5:.*]] = arith.cmpi uge, %[[VAL_0]], %[[VAL_4]] : i32
// CHECK:           %[[VAL_6:.*]] = arith.extui %[[VAL_5]] : i1 to i32
...
// CHECK-CANONICALIZED-LABEL:   func.func @branch_if_continue() -> i32 {
// CHECK-CANONICALIZED:           %[[VAL_0:.*]] = arith.constant 0 : i32
// CHECK-CANONICALIZED:           return %[[VAL_0]] : i32
// CHECK-CANONICALIZED:         }
...
// CHECK:           %[[VAL_9:.*]] = arith.cmpi uge, %[[VAL_7]], %[[VAL_8]] : i32
...
// CHECK:           %[[VAL_14:.*]] = arith.cmpi uge, %[[VAL_12]], %[[VAL_13]] : i32
// CHECK:           %[[VAL_15:.*]] = arith.extui %[[VAL_14]] : i1 to i32
