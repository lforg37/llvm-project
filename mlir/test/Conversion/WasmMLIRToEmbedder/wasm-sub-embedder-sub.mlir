...
// CHECK:         func.func private @wasm.sub_f32(f32, f32) -> f32
...
// CHECK:           %[[VAL_4:.*]] = call @wasm.sub_f32(%[[VAL_2]], %[[VAL_3]]) : (f32, f32) -> f32
...
// CHECK:         func.func private @wasm.sub_f64(f64, f64) -> f64
...
// CHECK:           %[[VAL_4:.*]] = call @wasm.sub_f64(%[[VAL_2]], %[[VAL_3]]) : (f64, f64) -> f64
