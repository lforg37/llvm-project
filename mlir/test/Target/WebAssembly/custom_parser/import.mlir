...
module {
  ...
  wasm.import_global "glob" from "my_module" as @global_0 nested : i32
  wasm.import_global "glob_mut" from "my_other_module" as @global_1 mutable nested : i32
}
...
// CHECK:         wasm.import_global "glob" from "my_module" as @global_0 nested : i32
// CHECK:         wasm.import_global "glob_mut" from "my_other_module" as @global_1 mutable nested : i32
