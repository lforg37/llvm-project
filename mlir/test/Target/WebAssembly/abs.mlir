// RUN: mlir-translate --import-wasm %S/inputs/abs.wasm | FileCheck %s
...
// CHECK-LABEL:   wasm.func @abs_f32() -> f32 {
// CHECK:           %[[VAL_0:.*]] = wasm.const 1.000000e+01 : f32
// CHECK:           %[[VAL_1:.*]] = wasm.abs %[[VAL_0]] : f32
// CHECK:           wasm.return %[[VAL_1]] : f32

// CHECK-LABEL:   wasm.func @abs_f64() -> f64 {
// CHECK:           %[[VAL_0:.*]] = wasm.const 1.000000e+01 : f64
// CHECK:           %[[VAL_1:.*]] = wasm.abs %[[VAL_0]] : f64
