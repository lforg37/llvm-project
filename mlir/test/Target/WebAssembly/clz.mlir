// RUN: mlir-translate --import-wasm %S/inputs/clz.wasm | FileCheck %s
...
// CHECK-LABEL:   wasm.func @clz_i32() -> i32 {
// CHECK:           %[[VAL_0:.*]] = wasm.const 10 : i32
// CHECK:           %[[VAL_1:.*]] = wasm.clz %[[VAL_0]] : i32
// CHECK:           wasm.return %[[VAL_1]] : i32

// CHECK-LABEL:   wasm.func @clz_i64() -> i64 {
// CHECK:           %[[VAL_0:.*]] = wasm.const 10 : i64
// CHECK:           %[[VAL_1:.*]] = wasm.clz %[[VAL_0]] : i64
