// RUN: mlir-translate --import-wasm %S/inputs/sqrt.wasm | FileCheck %s
...
// CHECK-LABEL:   wasm.func @sqrt_f32() -> f32 {
// CHECK:           %[[VAL_0:.*]] = wasm.const 1.000000e+01 : f32
// CHECK:           %[[VAL_1:.*]] = wasm.sqrt %[[VAL_0]] : f32
// CHECK:           wasm.return %[[VAL_1]] : f32

// CHECK-LABEL:   wasm.func @sqrt_f64() -> f64 {
// CHECK:           %[[VAL_0:.*]] = wasm.const 1.000000e+01 : f64
// CHECK:           %[[VAL_1:.*]] = wasm.sqrt %[[VAL_0]] : f64
