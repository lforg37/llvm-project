...
private:
  struct LabelLevel {
    size_t stackIdx;
    WasmSSALabelLevelInterface levelOp;
  };
public:
  ...
  void addLabelLevel(WasmSSALabelLevelInterface levelOp) {
...
private:
  ...
  struct NestingContext {
    NestingContext(ExpressionParser &parser, WasmSSALabelLevelInterface levelOp)
        : parser{parser} {
  ...
  void addNestingContextLevel(WasmSSALabelLevelInterface levelOp) {
  ...
  parseBlockContent(OpBuilder &builder, Block *blockToFill, TypeRange resTypes,
                    Location opLoc, WasmSSALabelLevelInterface levelOp,
...
public:
  ...
  NestingContext addNesting(WasmSSALabelLevelInterface levelOp) {
...
inline parsed_inst_t ExpressionParser::parseSpecificInstruction<
  ...
  builder.restoreInsertionPoint(sip);
  auto targetOp =
      WasmSSALabelBranchingInterface::getTargetOpFromBlock(curBlock, *level);
  if (failed(targetOp))
    return failure();
